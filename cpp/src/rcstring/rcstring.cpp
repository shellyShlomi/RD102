...
namespace ilrd
{
    ...
    static void RefCountStrCleanUp(RefCountStr *m_data, size_t size);
    static RefCountStr *InitRefCountStr(const char *str);
    static RefCountStr *DataKeeper(RefCountStr *to_assinge);
