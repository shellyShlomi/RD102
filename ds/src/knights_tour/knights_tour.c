                             ...
                             bit_arr_t chess_board)
{
    ...
    static char lut1[BOARD_AXIS * BOARD_AXIS][BOARD_AXIS] =
        {{10, 17, -1, -1, -1, -1, -1, -1},
         {11, 18, 16, -1, -1, -1, -1, -1},
         {12, 19, 17, 8, -1, -1, -1, -1},
         {13, 20, 18, 9, -1, -1, -1, -1},
    ...
    {
        if (-1 < lut1[(size_t)curr_position][i])
        {
            next_steps_lut[i].next_step = lut1[(size_t)curr_position][i];
            next_steps_lut[i].degree =
                GetDegree(lut1[(size_t)next_steps_lut[i].next_step], chess_board);
        }
    }
